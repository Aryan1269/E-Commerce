...
import { createitem } from "../../utils/product";
...
const Createproducts = () => {
  ...
  async function loadcategories() {
    ...
    setFormValues({ ...formValues, categories: rs.data });
  }
    ...
    <div className="flex justify-center items-center min-h-screen">
      ...
      >
        ...
        <div className="flex gap-2 mt-2 p-2 overflow-x-auto overflow-y-hidden flex-wrap max-w-[98%] h-[11%]">
          {/* <div class="relative w-[20%] h-[10%] w-full">
            <img
              src="https://images.unsplash.com/photo-1726766406089-0308c800b6b2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxmZWF0dXJlZC1waG90b3MtZmVlZHwzfHx8ZW58MHx8fHx8"
              alt=""
            />
